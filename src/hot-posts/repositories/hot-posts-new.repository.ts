...
import { RequiredHotPostColumnNew } from '../types/hot-post.type';
import { HOT_POST_REPOSITORY_TOKEN_NEW } from '../constants/hot-post.token';
import {
  EntityManager,
  FindManyOptions,
  FindOptionsWhere,
 ...
 */
@Injectable()
export class HotPostsRepositoryNew<E extends RequiredHotPostColumnNew> {
  constructor(
    @Inject(HOT_POST_REPOSITORY_TOKEN_NEW)
